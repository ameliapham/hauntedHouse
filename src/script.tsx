...
// Platform ------------------------------
const platformAlphaTexture = textureLoader.load('textures/platform/alpha.webp')
const platformAColorTexture = textureLoader.load('textures/platform/coast_sand_rocks_02_1k/coast_sand_rocks_02_diff_1k.webp')
const platformARMTexture = textureLoader.load('textures/platform/coast_sand_rocks_02_1k/coast_sand_rocks_02_arm_1k.webp')
const platformNormalTexture = textureLoader.load('textures/platform/coast_sand_rocks_02_1k/coast_sand_rocks_02_nor_gl_1k.webp')
const platformDisplacementTexture = textureLoader.load('textures/platform/coast_sand_rocks_02_1k/coast_sand_rocks_02_disp_1k.webp')
...
// First Floors ------------------------------
const firstFloorColorTexture = textureLoader.load('textures/wall/green_rough_planks_1k/green_rough_planks_diff_1k.webp')
const firstFloorARMTexture = textureLoader.load('textures/wall/green_rough_planks_1k/green_rough_planks_arm_1k.webp')
const firstFloorNormalTexture = textureLoader.load('textures/wall/green_rough_planks_1k/green_rough_planks_nor_gl_1k.webp')
...
// Second Floors ------------------------------
const secondFloorColorTexture = textureLoader.load('textures/wall/green_rough_planks_1k/green_rough_planks_diff_1k.webp')
const secondFloorARMTexture = textureLoader.load('textures/wall/green_rough_planks_1k/green_rough_planks_arm_1k.webp')
const secondFloorNormalTexture = textureLoader.load('textures/wall/green_rough_planks_1k/green_rough_planks_nor_gl_1k.webp')
...
// Ground Floor
const groundFloorColorTexture = textureLoader.load('textures/wall/wood_planks_grey_1k/wood_planks_grey_diff_1k.webp')
const groundFloorARMTexture = textureLoader.load('textures/wall/wood_planks_grey_1k/wood_planks_grey_arm_1k.webp')
const groundFloorNormalTexture = textureLoader.load('textures/wall/wood_planks_grey_1k/wood_planks_grey_nor_gl_1k.webp')
